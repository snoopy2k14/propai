...
const MOCK = [
  { id:'s1', title:'3 Bed Semi-Detached House', type:'SALE', price:425000, address:{city:'Manchester',postcode:'M21 9JQ'}, details:{bedrooms:3,bathrooms:2}, epcRating:'B' },
  { id:'s2', title:'Modern 2 Bed Apartment',    type:'SALE', price:280000, address:{city:'Leeds',postcode:'LS1 4DW'},       details:{bedrooms:2,bathrooms:1}, epcRating:'C' },
  { id:'s3', title:'4 Bed Detached House',      type:'SALE', price:695000, address:{city:'Bristol',postcode:'BS9 1LS'},     details:{bedrooms:4,bathrooms:3}, epcRating:'A', featured:true },
  { id:'s4', title:'1 Bed Studio Flat',         type:'SALE', price:195000, address:{city:'London',postcode:'E1 6RF'},       details:{bedrooms:1,bathrooms:1}, epcRating:'C' },
];

export default function SearchPage({ type = 'SALE' }) {
      ...
      <div className="bg-white border-b border-gray-200 sticky top-16 z-30">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-4">
          <div className="flex-1 flex items-center gap-2 bg-gray-50 rounded-xl px-4 py-2.5">
            ...
            <input value={query} onChange={e => setQuery(e.target.value)} placeholder="Search properties for sale..."
